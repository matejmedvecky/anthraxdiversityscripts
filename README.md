...
\# panSNP.txt file is generated by script 'extractAllSNPs.py'. If you generated your list of arregated SNPs by different means you may want to use script 'generate_SNPfile.py' to generate panSNP.txt file - see commented lines in that script for input clarification\
